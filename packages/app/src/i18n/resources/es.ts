...
export const es: TranslationResources = {
  ...
  dashboard: {
    ...
    compta: {
      ...
      goalLine: "Este mes: {{current}} / {{goal}} ({{pct}} %)",
      goalLegend: "Objetivo",
      due: "vence {{date}}",
      status: {
        draft: "Borrador",
  ...
  tasks: {
    ...
    panel: {
      ...
      evolutionInsertPrompt: "Añadir esta idea al mensaje",
      evolutionAddAll: "Añadirlas todas",
      evolutionRemoveAll: "Quitarlas todas",
      evolutionReorder: "Reordenar los puntos elegidos",
      evolutionRemovePrompt: "Quitar esta idea del mensaje",
      evolutionTaskCreated: "Tarea añadida al tablero",
      taskOfferConfirm: "Sí, conviértelo en tarea",
      taskOfferConfirmMessage: "Sí, conviértelo en una tarea.",
      taskOfferSent: "Solicitud enviada",
      chat: "Chat",
      details: "Detalles",
      noAgent: "Aún no se ha iniciado ningún agente para esta tarea.",
      launchAgent: "Iniciar el agente",
      runNowLaunching: "Iniciando…",
      runNowFailed: "Error al iniciar — reintentar",
      runNowEstimating: "Análisis en curso…",
      runNowWaitingQuota: "Esperando cuota — ejecutar ahora",
      runNowWaitingWindow: "Fuera de la ventana — ejecutar ahora",
      runNowWaitingSlot: "Todos los espacios están ocupados",
      ...
      restartDaemonCancelled: "Reinicio cancelado",
      restartResumed: "{{count}} agente(s) interrumpidos: se pidió reanudar",
      restartDaemonCountdown: "Reconectando en {{seconds}} s…",
      restartDaemonReconnecting: "Reconectando…",
      restartDaemonTimeout: "El motor no ha vuelto",
      restartDaemonDone: "Motor reiniciado ✅",
      deployThenRestart: "Publicar y reiniciar",
      deployThenRestartMessage:
        "Este trabajo necesitará reiniciar el motor. Puedes encadenarlo automáticamente en cuanto la publicación esté en línea.",
      deployThenRestartDispatched:
        "Publicación iniciada: el motor se reiniciará en cuanto esté en línea.",
      restartAfterDeployFiring: "Publicación en línea: reiniciando el motor…",
      ...
      billingLine: {
        ...
        alreadyBilled: "Ya facturado · {{number}}",
        ...
        relink: "Añadir a otro documento",
        linkedInvoice: "Añadida a la factura {{number}}",
        linkedQuote: "Añadida al presupuesto {{number}}",
    ...
    conductor: {
      ...
      switchProvider: "Cambiar a {{provider}}",
    ...
    filter: {
      ...
      priorityHeading: "Prioridad",
      deadlineHeading: "Fecha límite",
    ...
    quota: {
      title: "Cuota restante",
      buttonLabel: "Cuota restante",
      rolling: "Sesión (5 h)",
      weekly: "Cuota semanal",
      unavailable: "Consumo no disponible",
      remaining: "{{percent}} % restante",
      noData: "—",
      percentShort: "{{percent}} %",
      lowAlert: "{{provider}}: solo queda el {{percent}} % de la cuota semanal",
      history: "Últimos 7 días",
      forecastLasts: "A este ritmo, la semana aguanta",
      forecastRunsOut: "A este ritmo, se agota {{when}}",
      forecastToday: "hoy",
      forecastTomorrow: "mañana",
      resetsInMinutes: "Se reinicia en {{count}} min",
      resetsInHours: "Se reinicia en {{count}} h",
      resetsInDays: "Se reinicia en {{count}} d",
    },
    explorer: {
      title: "Explorador",
    ...
    filePreview: {
      close: "Cerrar la vista previa del archivo",
    },
    headerMenu: {
      label: "Más acciones",
    ...
    board: {
      ...
      staleEngineTitle: "Actualizar la versión del motor",
      staleEngineAction: "Actualizar",
      staleEngineUpdating: "Actualizando…",
      staleEngineStarted: "Actualización del motor iniciada",
      staleEngineFailed: "No se pudo iniciar la actualización del motor",
      ...
      deployResetMessage:
        "Borra el estado de error y cualquier bloqueo residual, luego inicia una publicación limpia. El motor se reinicia al final; los agentes en curso se interrumpirán.",
      deployResetConfirm: "Reiniciar y reintentar",
      deployResetStarted: "Nueva publicación iniciada",
      deployStopAction: "Detener",
      deployStopTitle: "Detener la publicación",
      deployStopMessage:
        "Interrumpe la publicación en curso: se detiene el script, se libera el bloqueo y las tarjetas vuelven a un estado coherente. No se publicará nada que no esté ya en línea.",
      deployStopConfirm: "Detener la publicación",
      deployStopStarted: "Publicación detenida",
      deployStopIdle: "No hay ninguna publicación en curso que detener",
      deployStopFailed: "No se pudo detener la publicación",
      archiveAll: "Archivar todo",
      archiveSelectionConfirm: "Archivar la selección ({{count}})",
      ...
      batchQueued: "Una publicación en espera — empezará en cuanto termine esta",
      batchOpenLog: "Ver el registro de publicación",
      deployLogTitle: "Registro de publicación",
      deployLogEmpty: "Ninguna publicación registrada.",
      deployLogLast: "Última publicación",
      deployLogFailed: "Esta publicación falló: no se publicó nada.",
      batchPhase: {
        start: "Inicio del despliegue",
        prepare: "Preparando cambios…",
        push: "Enviando al repositorio…",
    ...
    schedule: {
      ...
      awaitingSlotFree: "Todos los espacios ocupados",
      nextRun: "Hacia {{when}}",
    },
    card: {
      ...
      ridesNextPublish: "Saldrá en la próxima publicación",
      publishHeld: "Excluida del próximo lote",
    ...
    triage: {
      ...
      approveSelected: "Aprobar seleccionadas ({{count}})",
      save: "Guardar",
      approved: "Aprobada",
      refused: "Rechazada",
      folder: "Carpeta: {{name}}",
    ...
    detail: {
      ...
      execution: {
        ...
        prefAuto: "Auto",
        prefAutoHint: "Tareas ligeras en cualquier momento, pesadas en horas valle",
        prefAsap: "Lo antes posible",
        prefOffPeak: "Horas valle",
      },
    },
    actions: {
  ...
  agentTasks: {
    openDrawer: "Mostrar tareas ({{count}})",
    drawerTitle: "Tareas",
  ...
  agentTasksToast: {
    ...
    dismiss: "Descartar",
    dismissFinished: "Borrar completadas ({{count}})",
    dismissFinishedEmpty: "No hay completadas que borrar",
    clearMenu: "Borrar por categoría",
    clearFinishedCategory: "Completadas ({{count}})",
    clearFailedCategory: "Errores ({{count}})",
    clearNeedsInputCategory: "Esperándote ({{count}})",
    cleared: "{{count}} borradas",
    undo: "Deshacer",
    overflow: "+{{count}}",
  },
  agentList: {
  ...
  workspaceSetup: {
    ...
    errors: {
      ...
      hostDiskFull: "El disco del host está lleno — libera espacio e inténtalo de nuevo",
  ...
  settings: {
    ...
    project: {
      ...
      promptSync: {
        ...
        info: "Elige qué información local del proyecto comparte Paseo con los agentes para mantener sus instrucciones al día.",
        lastSynced: "Sincronizado {{time}}",
        waiting: "Esperando la primera sincronización",
        recentFiles: "Últimos archivos: {{files}}",
        noRecentFiles: "No hay archivos recientes",
        version: "Rama y última versión",
        changedFiles: "Archivos modificados recientemente",
