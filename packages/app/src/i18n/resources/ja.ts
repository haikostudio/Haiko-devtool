...
export const ja: TranslationResources = {
  ...
  tasks: {
    ...
    panel: {
      ...
      evolutionAddAll: "すべてメッセージに追加",
      evolutionRemoveAll: "すべてメッセージから削除",
      evolutionReorder: "選んだ項目を並べ替え",
      ...
      taskOfferSent: "リクエストを送信しました",
      chat: "チャット",
      details: "詳細",
      noAgent: "このタスクにはまだエージェントが起動されていません。",
      launchAgent: "エージェントを起動",
      runNowLaunching: "起動中…",
      runNowFailed: "起動に失敗 — 再試行",
      runNowEstimating: "分析中…",
      runNowWaitingQuota: "クォータ待ち — 今すぐ実行",
      runNowWaitingWindow: "時間帯外 — 今すぐ実行",
      runNowWaitingSlot: "すべての枠が使用中",
      approveTask: "タスクを承認",
      approveDispatched: "タスクを承認しました — 分析を実行中です。",
      validateTask: "タスクを完了する",
      validateTaskMessage:
        "カードは「完了」に移動するだけです。ここでは検証も公開も行われません。検証は公開時に実行されます。",
      validateAgentBusy: "エージェントはまだ作業中です…",
      validatePassed: "タスクを完了しました。",
      archiveTask: "アーカイブ",
      archiveTaskMessage:
      ...
      billingLine: {
        ...
        newInvoice: "新しい請求書",
        newQuote: "新しい見積書",
        existingDrafts: "既存の下書き",
        linkedClient: "顧客：{{name}} · {{company}}",
        linkHint: "この明細を請求書に追加するには、プロジェクト設定で顧客を紐付けてください。",
        addButton: "見積書または請求書に追加",
        relink: "別の書類に追加",
        linkedInvoice: "請求書 {{number}} に追加済み",
        linkedQuote: "見積書 {{number}} に追加済み",
        title: "請求明細",
        label: "項目",
        time: "見積時間",
        rate: "単価",
        amount: "金額",
        note: "参考見積です。この明細はまだ請求されていません。請求書に追加するにはエージェントに依頼してください。",
        noEstimate:
    ...
    quota: {
      ...
      lowAlert: "{{provider}}：週次上限の残りは {{percent}}% です",
      history: "過去7日間",
      forecastLasts: "このペースなら週内はもちます",
      forecastRunsOut: "このペースだと{{when}}に使い切ります",
      forecastToday: "今日",
      forecastTomorrow: "明日",
    ...
    board: {
      ...
      staleEngineTitle: "エンジンのバージョンを更新",
      staleEngineAction: "更新",
      staleEngineUpdating: "更新中…",
      staleEngineStarted: "エンジンの更新を開始しました",
      staleEngineFailed: "エンジンの更新を開始できませんでした",
      ...
      deployStopAction: "停止",
      deployStopTitle: "公開を停止",
      deployStopMessage:
        "実行中の公開を中断します。スクリプトを停止し、ロックを解放し、カードを整合した状態に戻します。まだ公開されていないものは反映されません。",
      deployStopConfirm: "公開を停止",
      deployStopStarted: "公開を停止しました",
      deployStopIdle: "停止できる公開は実行されていません",
      deployStopFailed: "公開を停止できませんでした",
      archiveAll: "すべてアーカイブ",
      archiveSelectionConfirm: "選択をアーカイブ ({{count}})",
      archiveSelectionCancel: "キャンセル",
      deployAgentTitle: "一括公開",
      deployMenu: "公開オプション",
    ...
    card: {
      ...
      needsRestart: "再起動が必要",
      republishOnly: "再公開のみ",
      ridesNextPublish: "次の公開に含まれます",
      publishHeld: "次のバッチから除外",
      planReady: "プラン完成",
    ...
    triage: {
      ...
      approveSelected: "選択したものを承認 ({{count}})",
      save: "保存",
      approved: "承認済み",
      refused: "却下済み",
      folder: "フォルダー: {{name}}",
    ...
    detail: {
      ...
      execution: {
        ...
        prefAuto: "自動",
        prefAutoHint: "軽いタスクは随時、重いタスクはオフピークに実行",
        prefAsap: "できるだけ早く",
        prefOffPeak: "オフピーク時間",
      },
    },
  ...
  agentTasksToast: {
    ...
    drag: "ドラッグして移動",
    dismiss: "閉じる",
    dismissFinished: "完了したものを消去（{{count}}）",
    dismissFinishedEmpty: "消去できる完了通知はありません",
    clearMenu: "カテゴリー別に消去",
    clearFinishedCategory: "完了（{{count}}）",
    clearFailedCategory: "エラー（{{count}}）",
    clearNeedsInputCategory: "入力待ち（{{count}}）",
    cleared: "{{count}} 件を消去しました",
    undo: "元に戻す",
    overflow: "+{{count}}",
  },
  agentList: {
  ...
  settings: {
    ...
    project: {
      ...
      billing: {
        ...
        client: "請求先の顧客",
        selectClient: "顧客を選択",
        noClients: "利用可能な顧客がありません",
        none: "請求しない",
        loadError: "顧客を読み込めませんでした。",
        saveError: "顧客を保存できませんでした。",
      },
      promptSync: {
        title: "プロジェクトの指示",
        info: "エージェントの指示を最新に保つため、Paseo が共有するローカル情報を選択します。",
        lastSynced: "{{time}}に同期",
        waiting: "最初の同期を待っています",
        recentFiles: "最新のファイル：{{files}}",
        noRecentFiles: "最近のファイルはありません",
        version: "ブランチと最新バージョン",
        changedFiles: "最近変更されたファイル",
