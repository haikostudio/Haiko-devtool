...
export const zhCN: TranslationResources = {
  ...
  tasks: {
    ...
    panel: {
      ...
      evolutionAddAll: "全部添加",
      evolutionRemoveAll: "全部移除",
      evolutionReorder: "重新排序所选要点",
      ...
      launchAgent: "启动智能体",
      runNowLaunching: "正在启动…",
      runNowFailed: "启动失败 — 重试",
      runNowEstimating: "分析进行中…",
      runNowWaitingQuota: "等待配额 — 立即运行",
      runNowWaitingWindow: "不在时段内 — 立即运行",
      runNowWaitingSlot: "所有名额都已占用",
      approveTask: "确认任务",
      approveDispatched: "任务已确认 — 正在分析。",
      validateTask: "完成任务",
      validateTaskMessage:
        "卡片只会移动到「已完成」。这里不做任何检查，也不会发布 — 验证会在发布时进行。",
      validateAgentBusy: "代理仍在工作中…",
      validatePassed: "任务已完成。",
      archiveTask: "归档",
      ...
      restartDaemonUndo: "取消（{{seconds}} 秒）",
      restartDaemonCancelled: "已取消重启",
      restartResumed: "已请求 {{count}} 个被中断的智能体继续",
      restartDaemonCountdown: "{{seconds}} 秒后重新连接…",
      restartDaemonReconnecting: "正在重新连接…",
      restartDaemonTimeout: "引擎没有回来",
      restartDaemonDone: "引擎已重启 ✅",
      deployThenRestart: "发布并重启",
      deployThenRestartMessage: "这项改动需要重启引擎。发布上线后可以自动接着完成重启。",
      deployThenRestartDispatched: "已开始发布 — 上线后将自动重启引擎。",
      restartAfterDeployFiring: "发布已上线 — 正在重启引擎…",
      collapse: "收起面板",
      expand: "展开面板",
      billing: "账单",
      analysis: {
      ...
      billingLine: {
        ...
        newQuote: "新建报价",
        existingDrafts: "现有草稿",
        linkedClient: "客户：{{name}} · {{company}}",
        linkHint: "在项目设置中将此项目关联到客户，即可添加到发票。",
        addButton: "添加到报价或发票",
        relink: "添加到其他文档",
        linkedInvoice: "已添加到发票 {{number}}",
        linkedQuote: "已添加到报价 {{number}}",
        title: "账单条目",
        label: "说明",
        time: "预计用时",
        rate: "费率",
        amount: "金额",
        note: "参考估算——此条目尚未开票。可请智能体将其添加到发票中。",
    ...
    quota: {
      ...
      lowAlert: "{{provider}}：每周配额仅剩 {{percent}}%",
      history: "最近 7 天",
      forecastLasts: "按此速度，本周够用",
      forecastRunsOut: "按此速度，{{when}}将用尽",
      forecastToday: "今天",
      forecastTomorrow: "明天",
    ...
    board: {
      ...
      queueAll: "全部加入队列",
      staleEngineTitle: "更新引擎版本",
      staleEngineAction: "更新",
      staleEngineUpdating: "正在更新…",
      staleEngineStarted: "已开始更新引擎",
      staleEngineFailed: "无法开始更新引擎",
      ...
      deployStopAction: "停止",
      deployStopTitle: "停止发布",
      deployStopMessage:
        "中断正在进行的发布：停止脚本、释放锁定，并将卡片恢复到一致状态。尚未上线的内容都不会被发布。",
      deployStopConfirm: "停止发布",
      deployStopStarted: "发布已停止",
      deployStopIdle: "没有正在进行的发布可停止",
      deployStopFailed: "无法停止发布",
      archiveAll: "全部归档",
    ...
    card: {
      ...
      ridesNextPublish: "将随下次发布上线",
      publishHeld: "已从下一批中移除",
      planReady: "计划已就绪",
      needsAction: "需要你处理",
      finished: "已完成",
      deploying: "发布中…",
    ...
    detail: {
      ...
      execution: {
        ...
        prefAuto: "自动",
        prefAutoHint: "轻任务随时执行，重任务在空闲时段执行",
        prefAsap: "尽快",
        prefOffPeak: "空闲时段",
      },
    },
  ...
  agentTasksToast: {
    ...
    drag: "拖动以移动",
    dismiss: "关闭",
    dismissFinished: "清除已完成（{{count}}）",
    dismissFinishedEmpty: "没有可清除的已完成通知",
    clearMenu: "按类别清除",
    clearFinishedCategory: "已完成（{{count}}）",
    clearFailedCategory: "错误（{{count}}）",
    clearNeedsInputCategory: "等待你（{{count}}）",
    cleared: "已清除 {{count}} 条",
    undo: "撤销",
    overflow: "+{{count}}",
  },
  ...
  settings: {
    ...
    project: {
      ...
      promptSync: {
        title: "项目指令",
        info: "选择 Paseo 与智能体共享的本地项目信息，以保持指令最新。",
        lastSynced: "已于 {{time}} 同步",
        waiting: "等待首次同步",
        recentFiles: "最近文件：{{files}}",
        noRecentFiles: "没有最近文件",
        version: "分支和最新版本",
        changedFiles: "最近修改的文件",
        workspaces: "活动工作区",
        remote: "远程仓库地址",
