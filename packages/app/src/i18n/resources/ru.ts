...
export const ru: TranslationResources = {
  ...
  dashboard: {
    ...
    compta: {
      ...
      goalLine: "Этот месяц: {{current}} / {{goal}} ({{pct}} %)",
      goalLegend: "Цель",
      due: "срок {{date}}",
      status: {
        draft: "Черновик",
  ...
  tasks: {
    ...
    panel: {
      ...
      evolutionAddAll: "Добавить все",
      evolutionRemoveAll: "Убрать все",
      evolutionReorder: "Изменить порядок выбранных пунктов",
      ...
      taskOfferSent: "Запрос отправлен",
      chat: "Чат",
      details: "Подробности",
      noAgent: "Для этой задачи ещё не запущен ни один агент.",
      launchAgent: "Запустить агента",
      runNowLaunching: "Запуск…",
      runNowFailed: "Запуск не удался — повторить",
      runNowEstimating: "Анализ выполняется…",
      runNowWaitingQuota: "Ожидание квоты — запустить сейчас",
      runNowWaitingWindow: "Вне окна — запустить сейчас",
      runNowWaitingSlot: "Все слоты заняты",
      approveTask: "Утвердить задачу",
      approveDispatched: "Задача утверждена — идёт анализ.",
      validateTask: "Завершить задачу",
      validateTaskMessage:
        "Карточка просто переходит в «Готово». Здесь ничего не проверяется и не публикуется — проверка выполняется при публикации.",
      validateAgentBusy: "Агент ещё работает…",
      validatePassed: "Задача завершена.",
      ...
      validateAndQueue: "Завершить и поставить в очередь",
      deployTaskMessage:
      ...
      billingLine: {
        ...
        alreadyBilled: "Уже выставлено · {{number}}",
        changeClient: "Изменить",
        added: "Добавлено в {{number}}",
        addError: "Не удалось добавить задачу в документ.",
        addTitle: "Добавить в документ",
        newInvoice: "Новый счёт",
        newQuote: "Новое предложение",
        existingDrafts: "Существующие черновики",
        linkedClient: "Клиент: {{name}} · {{company}}",
        linkHint: "Свяжите проект с клиентом в настройках проекта, чтобы добавить его в счёт.",
        addButton: "Добавить в предложение или счёт",
        relink: "Добавить в другой документ",
        linkedInvoice: "Добавлено в счёт {{number}}",
        linkedQuote: "Добавлено в предложение {{number}}",
        title: "Строка счёта",
        label: "Описание",
        time: "Оценка времени",
        rate: "Ставка",
        amount: "Сумма",
        note: "Ориентировочная оценка — эта строка ещё не выставлена в счёт. Попросите агента добавить её в счёт.",
        noEstimate: "Оценки пока нет. Запустите анализ задачи, чтобы рассчитать время и стоимость.",
      },
    },
    conductor: {
      title: "Дирижёр",
      ...
      switchProvider: "Переключиться на {{provider}}",
    ...
    quota: {
      ...
      lowAlert: "{{provider}}: осталось всего {{percent}} % недельной квоты",
      history: "Последние 7 дней",
      forecastLasts: "При таком темпе недели хватит",
      forecastRunsOut: "При таком темпе закончится {{when}}",
      forecastToday: "сегодня",
      forecastTomorrow: "завтра",
    ...
    board: {
      ...
      staleEngineTitle: "Обновить версию движка",
      staleEngineAction: "Обновить",
      staleEngineUpdating: "Обновление…",
      staleEngineStarted: "Обновление движка запущено",
      staleEngineFailed: "Не удалось запустить обновление движка",
      ...
      deployStopAction: "Остановить",
      deployStopTitle: "Остановить публикацию",
      deployStopMessage:
        "Прерывает текущую публикацию: скрипт останавливается, блокировка снимается, карточки возвращаются в согласованное состояние. Ничего, что ещё не в сети, опубликовано не будет.",
      deployStopConfirm: "Остановить публикацию",
      deployStopStarted: "Публикация остановлена",
      deployStopIdle: "Нет запущенной публикации для остановки",
      deployStopFailed: "Не удалось остановить публикацию",
      archiveAll: "Архивировать всё",
      archiveSelectionConfirm: "Архивировать выбранное ({{count}})",
      archiveSelectionCancel: "Отмена",
      deployAgentTitle: "Групповая публикация",
      deployMenu: "Параметры публикации",
    ...
    schedule: {
      ...
      awaitingSlotFree: "Все слоты заняты",
      nextRun: "Около {{when}}",
    },
    card: {
      ...
      ridesNextPublish: "Выйдет с следующей публикацией",
      publishHeld: "Исключена из следующей партии",
    ...
    detail: {
      ...
      execution: {
        ...
        prefAuto: "Авто",
        prefAutoHint: "Лёгкие задачи в любое время, тяжёлые — в тихие часы",
        prefAsap: "Как можно скорее",
        prefOffPeak: "Тихие часы",
      },
    },
    actions: {
  ...
  agentTasksToast: {
    ...
    dismiss: "Закрыть",
    dismissFinished: "Очистить завершённые ({{count}})",
    dismissFinishedEmpty: "Нет завершённых для очистки",
    clearMenu: "Очистить по категории",
    clearFinishedCategory: "Завершённые ({{count}})",
    clearFailedCategory: "Ошибки ({{count}})",
    clearNeedsInputCategory: "Ожидают вас ({{count}})",
    cleared: "Очищено: {{count}}",
    undo: "Отменить",
    overflow: "+{{count}}",
  },
  agentList: {
  ...
  settings: {
    ...
    project: {
      ...
      promptSync: {
        ...
        info: "Выберите, какие локальные сведения о проекте Paseo передаёт агентам для актуальных инструкций.",
        lastSynced: "Синхронизировано {{time}}",
        waiting: "Ожидание первой синхронизации",
        recentFiles: "Последние файлы: {{files}}",
        noRecentFiles: "Недавних файлов нет",
        version: "Ветка и последняя версия",
        changedFiles: "Недавно изменённые файлы",
