...
export const ru: TranslationResources = {
  ...
  tasks: {
    ...
    panel: {
      ...
      validateTask: "Запустить финальную проверку",
      validateTaskMessage:
        "Агент задачи перечитывает запрос, проверяет свою работу, исправляет ошибки, а затем помечает задачу как «Готово», если всё в порядке. Вы видите всё это в переписке.",
      validateRunning: "Проверка идёт в переписке…",
