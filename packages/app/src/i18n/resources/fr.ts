...
export const fr: TranslationResources = {
  ...
  agentControls: {
    ...
    options: {
      title: "Options",
      open: "Ouvrir les options de l'agent",
    },
    context: {
      title: "Contexte",
      saturation: "Saturation du contexte",
    },
    hints: {
  ...
  dashboard: {
    ...
    stats: {
      agentsToday: "Agents aujourd'hui",
      tokensIn: "Tokens entrée (30 j)",
      tokensOut: "Tokens sortie (30 j)",
      estimatedCost: "Coût estimé (30 j)",
      activityTitle: "Activité par projet",
      modeDays: "Jours",
      modeHours: "Heures",
      otherProjects: "Autres",
      empty:
        "Aucune activité enregistrée — les stats se construisent au fil du travail des agents.",
    ...
    compta: {
      ...
      goalLine: "Ce mois : {{current}} / {{goal}} ({{pct}} %)",
      goalLegend: "Objectif",
      due: "éch. {{date}}",
      status: {
        draft: "Brouillon",
  ...
  tasks: {
    ...
    panel: {
      ...
      taskOfferConfirmMessage: "Oui, fais-en une tâche.",
      taskOfferSent: "Demande envoyée",
      chat: "Discussion",
      details: "Détails",
      noAgent: "Aucun agent n'a encore été lancé pour cette tâche.",
      launchAgent: "Lancer l'agent",
      runNowLaunching: "Lancement en cours…",
      runNowFailed: "Échec du lancement — réessayer",
      runNowEstimating: "Analyse en cours…",
      runNowWaitingQuota: "En attente de quota — lancer maintenant",
      runNowWaitingWindow: "Hors créneau — lancer maintenant",
      runNowWaitingSlot: "Tous les créneaux sont occupés",
      ...
      restartDaemonUndo: "Annuler ({{seconds}} s)",
      restartDaemonCancelled: "Redémarrage annulé",
      restartResumed: "{{count}} agent(s) interrompus — reprise demandée",
      ...
      billingLine: {
        ...
        rate: "Taux",
        amount: "Montant",
        note: "Estimation indicative — cette ligne n'est pas encore facturée. Demandez à un agent de l'ajouter à une facture.",
        noEstimate:
    ...
    conductor: {
      ...
      switchProvider: "Basculer sur {{provider}}",
    ...
    folderModal: {
      ...
      editTitle: "Modifier le classeur",
      nameField: "Nom",
      colorField: "Couleur",
    ...
    quota: {
      ...
      lowAlert: "{{provider}} : plus que {{percent}} % de quota hebdomadaire",
      history: "7 derniers jours",
      forecastLasts: "À ce rythme, la semaine tient",
      forecastRunsOut: "À ce rythme, épuisé {{when}}",
    ...
    board: {
      ...
      staleEngineTitle: "Mettre à jour la version du moteur",
      staleEngineAction: "Mettre à jour",
      staleEngineUpdating: "Mise à jour…",
      staleEngineStarted: "Mise à jour du moteur lancée",
      staleEngineFailed: "Impossible de lancer la mise à jour du moteur",
      ...
      deployStopAction: "Arrêter",
      deployStopTitle: "Arrêter la publication",
      deployStopMessage:
        "Interrompt la publication en cours : le script est arrêté, le verrou libéré et les cartes reviennent dans un état cohérent. Rien de ce qui n'est pas encore en ligne ne sera publié.",
      deployStopConfirm: "Arrêter la publication",
      deployStopStarted: "Publication interrompue",
      deployStopIdle: "Aucune publication en cours à arrêter",
      deployStopFailed: "Impossible d'arrêter la publication",
    ...
    schedule: {
      ...
      awaitingSlotFree: "Tous les créneaux sont occupés",
      nextRun: "Vers {{when}}",
    },
    card: {
      ...
      ridesNextPublish: "Partira à la prochaine publication",
      publishHeld: "Retirée du prochain lot",
      planReady: "Plan prêt",
    ...
    status: {
      attention: "Nécessite une action de votre part",
      running: "En cours",
    ...
    git: {
      refresh: "Rafraîchir",
      refreshing: "Lecture…",
      resumeConflict: "Reprendre le conflit",
      resumingConflict: "Transmission…",
      size: "{{commits}} commit(s), {{files}} fichier(s) modifié(s)",
      stripFailed: "Étape en erreur : {{step}}",
      title: "GitHub",
      steps: {
        branch: "Branche",
        commit: "Commit",
    ...
    detail: {
      ...
      priorityMedium: "Moyenne",
      priorityLow: "Basse",
      deadlineField: "Échéance",
      deadlinePlaceholder: "15.07.26 ou « à définir »",
      sections: {
        content: "Contenu",
        classification: "Classement",
        estimate: "Estimation",
      },
      estimateDetail: "{{tokens}} tokens · confiance : {{confidence}}",
      noEstimate: "Pas encore d'estimation — glissez dans Planifié ou ré-estimez.",
      openPr: "Ouvrir la PR",
      ...
      usage: {
        ...
        breakdown: "{{input}} entrée · {{output}} sortie · {{turns}} tour(s)",
        cost: "≈ {{amount}} · réel",
        none: "Rien de consommé pour l'instant.",
      },
      cost: {
        billable: "≈ {{amount}} · temps",
        tokens: "≈ {{amount}} · tokens",
      },
      execution: {
        effectiveTitle: "Sera exécuté comme",
        effectiveModel: "Modèle : {{model}}",
        effectiveThinking: "Réflexion : {{level}}",
        ...
        thinkingDefault: "Par défaut",
        mode: "Mode",
        modeDirect: "Action directe",
        modeDirectHint: "Implémente directement dans le workspace en cours",
        modePlan: "Plan d'abord",
        modePlanHint: "Produit un plan puis s'arrête pour relecture",
        schedulePreference: "Lancement",
        prefAuto: "Auto",
        prefAutoHint: "Tâches légères à tout moment, lourdes en heures creuses",
        prefAsap: "Dès que possible",
        prefOffPeak: "Heures creuses",
      },
    },
    actions: {
      ...
      folderActions: "Actions du classeur",
    },
    toast: {
  ...
  agentTasksToast: {
    ...
    dismiss: "Fermer",
    dismissFinished: "Effacer les terminées ({{count}})",
    dismissFinishedEmpty: "Aucune notification terminée",
    clearMenu: "Effacer par catégorie",
    clearFinishedCategory: "Terminées ({{count}})",
    clearFailedCategory: "Erreurs ({{count}})",
    clearNeedsInputCategory: "En attente ({{count}})",
    cleared: "{{count}} effacée(s)",
    undo: "Annuler",
    overflow: "+{{count}}",
  },
  agentList: {
  ...
  settings: {
    ...
    project: {
      ...
      billing: {
        rate: "Taux horaire (CHF/h)",
        ratePlaceholder: "130",
        defaultDocument: "Document par défaut",
        defaultDocumentNone: "Aucun",
        linkedTo: "Client du projet : {{name}}",
        title: "Facturation",
      ...
      promptSync: {
        title: "Consignes projet",
        info: "Choisissez les informations locales que Paseo transmet aux agents pour garder leurs consignes à jour.",
        lastSynced: "Synchronisées {{time}}",
        waiting: "Synchronisation en attente",
        recentFiles: "Derniers fichiers : {{files}}",
        noRecentFiles: "Aucun fichier récent à signaler",
        version: "Branche et dernière version",
        changedFiles: "Fichiers modifiés récemment",
