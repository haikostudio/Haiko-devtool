...
export const fr: TranslationResources = {
  ...
  tasks: {
    ...
    gantt: {
      ...
      noBranchToSwitch: "Cette tâche n'a pas encore de branche — rien à afficher.",
    },
    view: {
      board: "Tableau",
    ...
    folders: "Branches",
    noFolders: "Aucune branche — créez-en une ci-dessous.",
    ...
    folderModal: {
      ...
      nameField: "Nom",
      branchField: "Branche git",
      branchHint: "Toutes les tâches de ce groupe committent sur cette branche.",
      branchPlaceholder: "feat/ma-branche",
      colorField: "Couleur",
    ...
    foldersSummary: "{{folders}} branche(s) · {{tasks}} tâche(s)",
