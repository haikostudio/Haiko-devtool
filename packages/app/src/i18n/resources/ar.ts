...
export const ar: TranslationResources = {
  ...
  dashboard: {
    ...
    compta: {
      ...
      goalLine: "هذا الشهر: {{current}} / {{goal}} ({{pct}} %)",
      goalLegend: "الهدف",
      due: "الاستحقاق {{date}}",
      status: {
        draft: "مسودة",
  ...
  tasks: {
    ...
    panel: {
      ...
      evolutionAddAll: "إضافة الكل إلى الرسالة",
      evolutionRemoveAll: "إزالة الكل من الرسالة",
      evolutionReorder: "إعادة ترتيب النقاط المختارة",
      evolutionRemovePrompt: "إزالة هذه الفكرة من الرسالة",
      evolutionTaskCreated: "تمت إضافة المهمة إلى اللوحة",
      taskOfferConfirm: "نعم، حوّلها إلى مهمة",
      taskOfferConfirmMessage: "نعم، حوّلها إلى مهمة.",
      taskOfferSent: "تم إرسال الطلب",
      chat: "المحادثة",
      details: "التفاصيل",
      noAgent: "لم يتم تشغيل أي وكيل لهذه المهمة بعد.",
      launchAgent: "تشغيل الوكيل",
      runNowLaunching: "جارٍ التشغيل…",
      runNowFailed: "فشل التشغيل — إعادة المحاولة",
      runNowEstimating: "التحليل جارٍ…",
      runNowWaitingQuota: "في انتظار الحصة — التشغيل الآن",
      runNowWaitingWindow: "خارج النافذة — التشغيل الآن",
      runNowWaitingSlot: "جميع الفترات مشغولة",
      approveTask: "اعتماد المهمة",
      approveDispatched: "تم اعتماد المهمة — التحليل قيد التنفيذ.",
      validateTask: "إنهاء المهمة",
      validateTaskMessage:
        "تنتقل البطاقة إلى «منجزة» فقط. لا يتم أي تحقق أو نشر هنا — يجري التحقق عند النشر.",
      validateAgentBusy: "لا يزال الوكيل يعمل…",
      validatePassed: "تم إنهاء المهمة.",
      archiveTask: "أرشفة",
      ...
      billingLine: {
        ...
        existingDrafts: "المسودّات الموجودة",
        linkedClient: "العميل: {{name}} · {{company}}",
        linkHint: "اربط هذا المشروع بعميل من إعدادات المشروع لإضافته إلى فاتورة.",
        addButton: "إضافة إلى عرض سعر أو فاتورة",
        relink: "الإضافة إلى مستند آخر",
        linkedInvoice: "أُضيفت إلى الفاتورة {{number}}",
        linkedQuote: "أُضيفت إلى عرض السعر {{number}}",
        title: "بند الفاتورة",
        label: "الوصف",
        time: "الوقت المقدَّر",
        rate: "السعر",
        amount: "المبلغ",
        note: "تقدير إرشادي — هذا البند لم يُفوتَر بعد. اطلب من وكيل إضافته إلى فاتورة.",
    ...
    filter: {
      title: "تصفية",
      empty: "لا توجد عوامل تصفية متاحة",
      clear: "مسح عوامل التصفية",
      priorityHeading: "الأولوية",
      deadlineHeading: "الموعد النهائي",
      tagsHeading: "الوسوم",
      priorityHigh: "عالية",
    ...
    quota: {
      ...
      lowAlert: "{{provider}}: لم يتبقَّ سوى {{percent}}٪ من الحصة الأسبوعية",
      history: "آخر 7 أيام",
      forecastLasts: "بهذه الوتيرة، يكفي الأسبوع",
      forecastRunsOut: "بهذه الوتيرة، سينفد {{when}}",
      forecastToday: "اليوم",
      forecastTomorrow: "غدًا",
    ...
    board: {
      ...
      staleEngineTitle: "تحديث إصدار المحرك",
      staleEngineAction: "تحديث",
      staleEngineUpdating: "جارٍ التحديث…",
      staleEngineStarted: "بدأ تحديث المحرك",
      staleEngineFailed: "تعذر بدء تحديث المحرك",
      ...
      deployStopAction: "إيقاف",
      deployStopTitle: "إيقاف النشر",
      deployStopMessage:
        "يوقف عملية النشر الجارية: يُنهى السكربت، ويُحرَّر القفل، وتعود البطاقات إلى حالة متسقة. لن يُنشر أي شيء ليس متاحًا بالفعل على الإنترنت.",
      deployStopConfirm: "إيقاف النشر",
      deployStopStarted: "تم إيقاف النشر",
      deployStopIdle: "لا يوجد نشر جارٍ لإيقافه",
      deployStopFailed: "تعذّر إيقاف النشر",
      archiveAll: "أرشفة الكل",
      archiveSelectionConfirm: "أرشفة المحدد ({{count}})",
      archiveSelectionCancel: "إلغاء",
      deployAgentTitle: "النشر الجماعي",
      ...
      batchPhase: {
        ...
        push: "جارٍ الإرسال إلى المستودع…",
    ...
    schedule: {
      ...
      awaitingSlotFree: "جميع الفترات مشغولة",
      nextRun: "حوالي {{when}}",
    },
    card: {
      ...
      ridesNextPublish: "سيُنشر مع النشر القادم",
      publishHeld: "مستبعدة من الدفعة القادمة",
    ...
    triage: {
      ...
      approveSelected: "الموافقة على المحدد ({{count}})",
      save: "حفظ",
    ...
    detail: {
      ...
      execution: {
        ...
        prefAuto: "تلقائي",
        prefAutoHint: "المهام الخفيفة في أي وقت، والثقيلة في ساعات الهدوء",
        prefAsap: "في أقرب وقت",
        prefOffPeak: "ساعات الهدوء",
      },
    },
    actions: {
  ...
  agentTasksToast: {
    ...
    drag: "اسحب للتحريك",
    dismiss: "إغلاق",
    dismissFinished: "مسح المكتملة ({{count}})",
    dismissFinishedEmpty: "لا توجد إشعارات مكتملة للمسح",
    clearMenu: "مسح حسب الفئة",
    clearFinishedCategory: "مكتملة ({{count}})",
    clearFailedCategory: "أخطاء ({{count}})",
    clearNeedsInputCategory: "بانتظارك ({{count}})",
    cleared: "تم مسح {{count}}",
    undo: "تراجع",
    overflow: "+{{count}}",
  },
  agentList: {
  ...
  settings: {
    ...
    project: {
      ...
      promptSync: {
        ...
        info: "اختر معلومات المشروع المحلية التي يشاركها Paseo مع الوكلاء لتبقى تعليماتهم محدّثة.",
        lastSynced: "تمت المزامنة {{time}}",
        waiting: "بانتظار أول مزامنة",
        recentFiles: "أحدث الملفات: {{files}}",
        noRecentFiles: "لا توجد ملفات حديثة",
        version: "الفرع وأحدث إصدار",
        changedFiles: "الملفات المعدّلة حديثاً",
