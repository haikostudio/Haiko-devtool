export const en = {
  ...
  dashboard: {
    ...
    compta: {
      ...
      goalLine: "This month: {{current}} / {{goal}} ({{pct}} %)",
      goalLegend: "Goal",
      due: "due {{date}}",
      status: {
        draft: "Draft",
  ...
  tasks: {
    ...
    panel: {
      ...
      taskOfferConfirmMessage: "Yes, make it a task.",
      taskOfferSent: "Request sent",
      chat: "Chat",
      details: "Details",
      noAgent: "No agent has been started for this task yet.",
      launchAgent: "Launch the agent",
      runNowLaunching: "Launching…",
      runNowFailed: "Launch failed — retry",
      runNowEstimating: "Analysis in progress…",
      runNowWaitingQuota: "Waiting for quota — run now",
      runNowWaitingWindow: "Outside the window — run now",
      runNowWaitingSibling: "Another task holds the folder",
      runNowWaitingSlot: "Every slot is busy",
      approveTask: "Validate the task",
      approveDispatched: "Task validated — analysis under way.",
      validateTask: "Finish the task",
      validateTaskMessage:
        "The card simply moves to “Done”. Nothing is checked and nothing is published here — the verification runs when you publish it.",
      validateAgentBusy: "The agent is still working…",
      validatePassed: "Task finished.",
      archiveTask: "Archive",
      archiveTaskMessage:
      ...
      billingLine: {
        ...
        linkHint: "Link this project to a client in the project settings to add it to an invoice.",
        addButton: "Add to a quote or invoice",
        relink: "Add to another document",
        linkedInvoice: "Added to invoice {{number}}",
        linkedQuote: "Added to quote {{number}}",
        title: "Invoice line",
        label: "Description",
        time: "Estimated time",
        rate: "Rate",
        amount: "Amount",
        note: "Indicative estimate — this line isn't invoiced yet. Ask an agent to add it to an invoice.",
    ...
    quota: {
      ...
      lowAlert: "{{provider}}: only {{percent}}% of the weekly allowance left",
      history: "Last 7 days",
      forecastLasts: "At this rate, the week holds",
      forecastRunsOut: "At this rate, spent {{when}}",
      forecastToday: "today",
    ...
    board: {
      ...
      queueAll: "Queue all",
      staleEngineTitle: "Update the engine version",
      staleEngineAction: "Update",
      staleEngineUpdating: "Updating…",
      staleEngineStarted: "Engine update started",
      staleEngineFailed: "Unable to start the engine update",
      ...
      deployStopAction: "Stop",
      deployStopTitle: "Stop the publication",
      deployStopMessage:
        "Interrupts the running publication: the script is stopped, the lock released and the cards return to a coherent state. Nothing that is not already online will be published.",
      deployStopConfirm: "Stop the publication",
      deployStopStarted: "Publication stopped",
      deployStopIdle: "No publication is running to stop",
      deployStopFailed: "Could not stop the publication",
      ...
      batchPhase: {
        ...
        prepare: "Saving the changes…",
        push: "Pushing to the repository…",
    ...
    schedule: {
      ...
      awaitingSibling: "Another task holds the folder",
      awaitingSlotFree: "Every slot is busy",
      nextRun: "Runs ~{{when}}",
    },
    card: {
      ...
      ridesNextPublish: "Ships with the next publication",
      publishHeld: "Held out of the next batch",
    ...
    detail: {
      ...
      execution: {
        ...
        prefAuto: "Auto",
        prefAutoHint: "Light tasks anytime, heavy ones during off-peak hours",
        prefAsap: "As soon as possible",
        prefOffPeak: "Off-peak hours",
      },
    },
    actions: {
  ...
  agentTasksToast: {
    ...
    drag: "Drag to move",
    dismiss: "Dismiss",
    dismissFinished: "Clear finished ({{count}})",
    dismissFinishedEmpty: "Nothing finished to clear",
    clearMenu: "Clear by category",
    clearFinishedCategory: "Finished ({{count}})",
    clearFailedCategory: "Errors ({{count}})",
    clearNeedsInputCategory: "Waiting on you ({{count}})",
  ...
  settings: {
    ...
    project: {
      ...
      promptSync: {
        ...
        info: "Choose which local project information Paseo shares with agents to keep their instructions current.",
        lastSynced: "Synced {{time}}",
        waiting: "Waiting for first sync",
        recentFiles: "Latest files: {{files}}",
        noRecentFiles: "No recent files to report",
        version: "Branch and latest version",
        changedFiles: "Recently changed files",
