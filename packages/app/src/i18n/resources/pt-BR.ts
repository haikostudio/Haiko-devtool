...
export const ptBR: TranslationResources = {
  ...
  dashboard: {
    ...
    stats: {
      agentsToday: "Agentes hoje",
      tokensIn: "Tokens entrada (30 d)",
      tokensOut: "Tokens saída (30 d)",
      estimatedCost: "Custo est. (30 d)",
      activityTitle: "Atividade por projeto",
      modeDays: "Dias",
      modeHours: "Horas",
      otherProjects: "Outros",
      empty:
        "Nenhum uso registrado ainda — as estatísticas se acumulam conforme os agentes trabalham.",
    ...
    compta: {
      ...
      goalLine: "Este mês: {{current}} / {{goal}} ({{pct}} %)",
      goalLegend: "Meta",
      due: "vence {{date}}",
      status: {
        draft: "Rascunho",
  ...
  tasks: {
    ...
    panel: {
      ...
      taskOfferConfirmMessage: "Sim, transforme isso em uma tarefa.",
      taskOfferSent: "Pedido enviado",
      chat: "Conversa",
      details: "Detalhes",
      noAgent: "Nenhum agente foi iniciado para esta tarefa ainda.",
      launchAgent: "Iniciar o agente",
      runNowLaunching: "Iniciando…",
      runNowFailed: "Falha ao iniciar — tentar novamente",
      runNowEstimating: "Análise em andamento…",
      runNowWaitingQuota: "Aguardando cota — executar agora",
      runNowWaitingWindow: "Fora da janela — executar agora",
      runNowWaitingSibling: "Outra tarefa ocupa a pasta",
      runNowWaitingSlot: "Todas as vagas estão ocupadas",
    ...
    filter: {
      ...
      priorityHeading: "Prioridade",
      deadlineHeading: "Prazo",
      tagsHeading: "Tags",
      priorityHigh: "Alta",
    ...
    quota: {
      ...
      lowAlert: "{{provider}}: resta apenas {{percent}}% da cota semanal",
      history: "Últimos 7 dias",
      forecastLasts: "Nesse ritmo, a semana aguenta",
      forecastRunsOut: "Nesse ritmo, acaba {{when}}",
      forecastToday: "hoje",
      forecastTomorrow: "amanhã",
    ...
    board: {
      ...
      staleEngineTitle: "Atualizar a versão do motor",
      staleEngineAction: "Atualizar",
      staleEngineUpdating: "Atualizando…",
      staleEngineStarted: "Atualização do motor iniciada",
      staleEngineFailed: "Não foi possível iniciar a atualização do motor",
      ...
      deploySendFailedTitle: "A solicitação não chegou ao motor",
      deploySendFailedBody:
        "A conexão com o motor estava fechando, então nada foi enviado. Tente novamente.",
      deploySendRetry: "Tentar novamente",
      ...
      deployStopAction: "Parar",
      deployStopTitle: "Parar a publicação",
      deployStopMessage:
        "Interrompe a publicação em andamento: o script é parado, o bloqueio é liberado e os cartões voltam a um estado coerente. Nada que ainda não esteja online será publicado.",
      deployStopConfirm: "Parar a publicação",
      deployStopStarted: "Publicação interrompida",
      deployStopIdle: "Nenhuma publicação em andamento para parar",
      deployStopFailed: "Não foi possível parar a publicação",
      ...
      batchPhase: {
        ...
        push: "Enviando para o repositório…",
    ...
    schedule: {
      ...
      awaitingSibling: "Outra tarefa ocupa a pasta",
      awaitingSlotFree: "Todas as vagas ocupadas",
    ...
    card: {
      ...
      ridesNextPublish: "Sai na próxima publicação",
      publishHeld: "Fora do próximo lote",
    ...
    triage: {
      ...
      approveSelected: "Aprovar selecionadas ({{count}})",
      save: "Salvar",
      approved: "Aprovada",
      refused: "Recusada",
      folder: "Pasta: {{name}}",
    ...
    detail: {
      ...
      usage: {
        ...
        breakdown: "{{input}} entrada · {{output}} saída · {{turns}} turno(s)",
        cost: "≈ {{amount}} · real",
        none: "Nada consumido ainda.",
      },
      cost: {
      ...
      execution: {
        effectiveTitle: "Será executado como",
        effectiveModel: "Modelo: {{model}}",
        effectiveThinking: "Raciocínio: {{level}}",
        defaultSuffix: "(padrão)",
        title: "Execução",
        model: "Modelo",
        modelDefault: "Modelo padrão",
        noModels: "Nenhum modelo disponível",
        thinking: "Nível de raciocínio",
        thinkingDefault: "Padrão",
        mode: "Modo",
        modeDirect: "Ação direta",
        modeDirectHint: "Implementa diretamente no workspace atual",
        modePlan: "Plano primeiro",
        modePlanHint: "Gera um plano e pausa para revisão",
        schedulePreference: "Momento de execução",
        prefAuto: "Auto",
        prefAutoHint: "Tarefas leves a qualquer hora, pesadas em horário de baixa",
        prefAsap: "O mais cedo possível",
        prefOffPeak: "Horário de baixa",
      },
    },
    actions: {
  ...
  agentTasksToast: {
    ...
    dismiss: "Dispensar",
    dismissFinished: "Limpar concluídas ({{count}})",
    dismissFinishedEmpty: "Nada concluído para limpar",
    clearMenu: "Limpar por categoria",
    clearFinishedCategory: "Concluídas ({{count}})",
    clearFailedCategory: "Erros ({{count}})",
    clearNeedsInputCategory: "Aguardando você ({{count}})",
    cleared: "{{count}} limpas",
    undo: "Desfazer",
    overflow: "+{{count}}",
  },
  agentList: {
  ...
  settings: {
    ...
    project: {
      ...
      promptSync: {
        ...
        info: "Escolha quais informações locais do projeto o Paseo compartilha com os agentes para manter as instruções atualizadas.",
        lastSynced: "Sincronizado {{time}}",
        waiting: "Aguardando a primeira sincronização",
        recentFiles: "Arquivos recentes: {{files}}",
        noRecentFiles: "Nenhum arquivo recente",
        version: "Branch e versão mais recente",
        changedFiles: "Arquivos alterados recentemente",
